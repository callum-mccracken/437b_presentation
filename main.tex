...
\setlength{\metropolis@progressinheadfoot@linewidth}{1pt}% just to better see that it's working
...
{%
\setbeamertemplate{frame footer}{Image sources: \href{link}{\alert{Accelerator Complex}}, \href{link}{\alert{ATLAS}}, \href{link}{\alert{Standard Model}}}
...
\begin{frame}{The Big Picture -- Measuring the Higgs Self-Coupling}
  ...
  Constant and $\phi$ terms can be removed via change of coordinates, but $\phi^2$: mass term, $\phi^3$: self-interaction or \alert{self-coupling} term, not well constrained.
