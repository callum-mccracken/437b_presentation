...
\begin{frame}{The Big Picture -- Measuring the Higgs Self-Coupling}
  ...
  \begin{itemize}
    \item Constant and $\phi$ terms: can eliminate with change of coordinates, $\phi^2$: mass term,\\
    $\phi^3$: self-interaction or \alert{self-coupling} term, not well constrained
  \end{itemize}
